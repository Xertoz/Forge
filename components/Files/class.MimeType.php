	...
	*/
	...
	class MimeType {
		static private $types = [
			...
			'mp3' => 'audio/mpeg', 'mp4' => 'video/mp4', 'mpe' => 'video/mpeg',
		...
		/**
		 * Determine the MIME type from a filename's extension
		 * @param string $filename
		 * @return string
		 */
		static public function fromExtension($filename) {
			$components = explode('.', $filename);
			$ext = array_pop($components);
			
			return isset(self::$types[$ext]) ? self::$types[$ext] : 'text/plain';
		}
	}