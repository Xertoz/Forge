<?php
	...
	*/
	...
	class JavaScript {
		 ...
		 */
		public function __construct($script, $type=JavaScript::TYPE_SOURCE, $minify=true) {
			if ($type & JavaScript::TYPE_FILE) {
				$this->type = $script[0] === '/' && $script[1] !== '/' ?
					JavaScript::TYPE_LOCAL : JavaScript::TYPE_REMOTE;
			}
			else
				$this->type = $type;
