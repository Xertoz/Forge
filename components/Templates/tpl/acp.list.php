<div id="templates" class="panel">
	...
	<p><?php echo self::l('You may select which one of the installed templates to use.'); ?></p>
	<p><?php echo self::l('A template may not be eligible for use on your site depending on installed modules'); ?></p>
